...
const CommercialSolar = () => {
    ...
    <div className="animate-fade-in bg-white">
      <SEOHead
        ...
        schema={[
        {
          ...
          description: 'Industrial-grade solar infrastructure for businesses, factories, and commercial buildings with up to 80% energy cost reduction.',
        ...
        },
        {
          ...
          '@type': 'FAQPage',
          mainEntity: [
            { '@type': 'Question', name: 'What system size does my business need?', acceptedAnswer: { '@type': 'Answer', text: 'A typical commercial setup ranges from 50kW to 500kW depending on consumption, roof area, and energy goals. Wattex conducts a free site survey to recommend optimal size.' } },
            { '@type': 'Question', name: 'What are the tax benefits for businesses going solar?', acceptedAnswer: { '@type': 'Answer', text: 'Commercial solar qualifies for 40% accelerated depreciation in Year 1 plus GST input credit. Combined, these can reduce effective system cost by up to 50%.' } },
            { '@type': 'Question', name: 'What is the typical ROI for commercial solar?', acceptedAnswer: { '@type': 'Answer', text: 'Commercial solar achieves 33-48% annual returns with 2-3 year payback. A typical 100kW system generates cumulative savings of ₹2-5 Crore over its 25-year lifespan.' } },
            { '@type': 'Question', name: 'Are financing options available for businesses?', acceptedAnswer: { '@type': 'Answer', text: 'Yes — outright purchase, EMI plans, OPEX/PPA models (zero upfront cost), and lease arrangements available. Our advisors help choose the best fit for your cash flow.' } },
            { '@type': 'Question', name: 'How long does a commercial installation take?', acceptedAnswer: { '@type': 'Answer', text: 'A 50-200kW installation takes 3-5 weeks from approval to commissioning. Larger 500kW+ projects may take 5-10 weeks including structural analysis and grid coordination.' } },
          ],
        },
      ]}
      />
      ...
      <section className="relative h-[100vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img loading="lazy" src={commercial} className="w-full h-full object-cover" alt="Commercial solar panel installation on factory rooftop in Hyderabad" />
  ...
  Future-Proof Your
  <br />
  <span className="block mt-2 sm:mt-4 text-solar-primary">Enterprise Energy .</span>
</h1>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <div className="space-y-8 sm:space-y-12">
              <div className="space-y-4">
                ...
                <h2 className="text-3xl sm:text-5xl font-black text-solar-deep tracking-tight">The Business Case for Solar</h2>
                ...
                {[
                  ...
                  <div key={i} className="flex gap-4 sm:gap-6 group">
                    ...
                    <div className="space-y-1">
                      <h4 className="text-lg sm:text-xl font-bold text-solar-deep">{item.title}</h4>
            ...
            <div className="relative mt-8 lg:mt-0">
              <div className="rounded-[3rem] sm:rounded-[4rem] overflow-hidden shadow-4xl aspect-[4/5]">
                <img loading="lazy" src={Commercial2} className="w-full h-full object-cover" alt="Industrial-grade solar panels on warehouse roof by Wattex Energy" />
              </div>
      ...
      <section className="py-16 sm:py-24 bg-solar-deep text-white overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mt-4 tracking-tight">Numbers That Define Trust</h2>
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
            {[
              { value: '50+', label: 'Commercial Clients', icon: 'fa-building' },
              { value: '₹3Cr+', label: 'Energy Savings Delivered', icon: 'fa-indian-rupee-sign' },
              { value: '1.5MW', label: 'Installed Capacity', icon: 'fa-solar-panel' },
              ...
              <div key={i} className="text-center group">
                ...
                <div className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight">{stat.value}</div>
                <div className="text-white/40 font-bold uppercase tracking-widest text-[10px] mt-2 sm:mt-3">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-32 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-20 space-y-4">
            ...
            <h2 className="text-3xl sm:text-5xl md:text-5xl font-black text-solar-deep tracking-tight">Industries We Power</h2>
            <p className="text-slate-500 text-base sm:text-xl font-medium max-w-2xl mx-auto">Tailored solar solutions engineered for the unique energy demands of every industry.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <div key={i} className="group p-4 sm:p-8 rounded-[1.5rem] sm:rounded-[2.5rem] bg-slate-50 border border-slate-100 hover:bg-white hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 text-center">
                <div className={`w-12 h-12 sm:w-16 sm:h-16 ${item.color} rounded-2xl flex items-center justify-center text-xl sm:text-2xl mx-auto mb-4 sm:mb-6 group-hover:scale-110 transition-transform`}>
                  <i className={`fas ${item.icon}`}></i>
                </div>
                <h3 className="text-sm sm:text-lg font-black text-solar-deep mb-1 sm:mb-2">{item.name}</h3>
                <p className="text-slate-500 text-xs sm:text-sm font-medium leading-relaxed hidden sm:block">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="max-w-4xl space-y-4 sm:space-y-6 animate-fade-in">
            ...
            <div className="flex flex-wrap justify-center gap-6 sm:gap-12 pt-4 sm:pt-8">
              <div className="text-center">
                <div className="text-3xl sm:text-4xl md:text-4xl font-black text-white">5+</div>
              ...
              <div className="text-center">
                <div className="text-2xl sm:text-4xl md:text-4xl font-black text-white">50kW–50MW</div>
                <div className="text-[10px] font-black uppercase tracking-widest text-white/40 mt-2">System Range</div>
              </div>
              <div className="w-px h-16 bg-white/20 hidden md:block"></div>
              <div className="text-center">
                <div className="text-3xl sm:text-4xl md:text-4xl font-black text-white">1-3 Weeks</div>
      ...
      <section className="py-16 sm:py-32 bg-slate-50">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-24 space-y-4">
            ...
            <h2 className="text-3xl sm:text-5xl md:text-5xl font-black text-solar-deep tracking-tight">From Inquiry to Energy in 4 Steps</h2>
            <p className="text-slate-500 text-base sm:text-xl font-medium max-w-2xl mx-auto">Our streamlined process makes the transition to solar effortless for your business.</p>
          </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10">
              {[
                ...
                <div key={i} className="relative text-center group">
                  <div className={`w-20 h-20 sm:w-32 sm:h-32 mx-auto mb-4 sm:mb-8 rounded-full bg-white border-4 ${step.color} shadow-xl flex items-center justify-center relative z-10 group-hover:scale-110 transition-transform duration-500`}>
                    <i className={`fas ${step.icon} text-2xl sm:text-4xl text-solar-deep group-hover:text-solar-primary transition-colors`}></i>
                  </div>
                  <div className="text-solar-primary font-black text-xs sm:text-sm tracking-widest mb-2 sm:mb-3">{step.num}</div>
                  <h3 className="text-base sm:text-xl font-black text-solar-deep mb-2 sm:mb-3">{step.title}</h3>
                  <p className="text-slate-500 text-xs sm:text-sm font-medium leading-relaxed hidden sm:block">{step.desc}</p>
                </div>
              ))}
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <div className="space-y-8 sm:space-y-12">
              <div className="space-y-4">
                ...
                <h2 className="text-3xl sm:text-5xl md:text-5xl font-black text-solar-deep tracking-tight">ROI That Speaks <br />for Itself</h2>
                <p className="text-slate-500 text-base sm:text-xl leading-relaxed font-medium">
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                {[
                  { label: 'Payback Period', value: '2.5 Years', icon: 'fa-clock-rotate-left', accent: true },
                  { label: 'Annual Savings', value: '₹15 Lakhs', icon: 'fa-piggy-bank', accent: true },
                  { label: '25-Year Returns', value: '₹4.5 Crores', icon: 'fa-chart-line', accent: false },
                  { label: 'Carbon Offset', value: '125 Tons/yr', icon: 'fa-leaf', accent: false },
                ].map((item, i) => (
                  <div key={i} className={`p-5 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] border ${item.accent ? 'bg-rose-50/50 border-rose-100' : 'bg-slate-50 border-slate-100'} group hover:shadow-xl transition-all duration-500`}>
                    <div className={`w-8 h-8 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center text-base sm:text-lg mb-3 sm:mb-4 ${item.accent ? 'bg-solar-primary/10 text-solar-primary' : 'bg-slate-100 text-slate-400'}`}>
                      <i className={`fas ${item.icon}`}></i>
                    </div>
                    <div className={`text-xl sm:text-3xl font-black tracking-tight mb-1 ${item.accent ? 'text-solar-primary' : 'text-solar-deep'}`}>{item.value}</div>
              ...
              <div className="bg-solar-deep rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-8 lg:p-12 shadow-2xl overflow-hidden relative">
                ...
                <div className="flex items-center justify-between mb-6 sm:mb-10 relative z-10">
                  <div>
                    ...
                    <div className="text-white font-extrabold text-base sm:text-xl">100kW Commercial System</div>
                  </div>
                  <div className="flex items-center gap-1.5 bg-emerald-500/10 border border-emerald-500/20 px-2 sm:px-3 py-1.5 rounded-full">
                    ...
                    <span className="text-[10px] font-bold text-emerald-400 hidden sm:inline">Live Tracking</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-4 sm:gap-0">
                  <div className="relative flex items-center justify-center">
                    <svg viewBox="0 0 260 260" className="w-[180px] h-[180px] sm:w-[220px] sm:h-[220px] transform -rotate-90">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center center-anim">
                      ...
                      <div className="text-3xl sm:text-5xl font-black text-white tracking-tight leading-none mb-1">&#8377;4.5<span className="text-lg sm:text-2xl text-white/60 ml-1">Cr</span></div>
                      <div className="text-[10px] font-bold text-solar-primary">Over 30 Years</div>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 justify-center sm:hidden w-full">
                    <div className="bg-white/5 border border-white/10 rounded-2xl px-4 py-3 text-center flex-1">
                      <div className="text-base font-black text-white leading-none">&#8377;15L</div>
                    ...
                    <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-2xl px-4 py-3 text-center flex-1">
                      <div className="text-base font-black text-emerald-400 leading-none">2.5Yrs</div>
                    ...
                    <div className="bg-sky-500/10 border border-sky-500/20 rounded-2xl px-4 py-3 text-center flex-1">
                      <div className="text-base font-black text-sky-400 leading-none">125T</div>
                ...
                <div className="hidden sm:block">
                  <div className="absolute top-[30%] right-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl px-4 py-3 text-center float-up-1 float-badge">
                    <div className="text-lg font-black text-white leading-none">&#8377;15L</div>
                    <div className="text-[8px] font-bold text-white/30 uppercase tracking-wider mt-1">Per Year</div>
                  </div>
                  <div className="absolute top-[55%] left-4 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl px-4 py-3 text-center float-up-2 float-badge-2">
                    <div className="text-lg font-black text-emerald-400 leading-none">2 Yrs</div>
                    <div className="text-[8px] font-bold text-emerald-400/50 uppercase tracking-wider mt-1">Payback</div>
                  </div>
...
<div className="grid grid-cols-3 gap-1 sm:flex sm:gap-3 sm:overflow-x-auto pb-1">
                    {[
                      ...
                      <div key={i} className={`rounded-xl p-2 sm:p-3 ... text-center border min-w-[52px] ${m.done ? 'bg-solar-primary/5 border-solar-primary/15' : 'bg-white/[0.02] border-white/5'}`}>
                        <div className={`text-xs sm:text-sm font-black ${m.done ? 'text-solar-primary' : 'text-white/40'}`}>{m.amt}</div>
              ...
              <div className="absolute -bottom-6 -right-6 bg-solar-primary p-7 rounded-[2rem] shadow-2xl shadow-rose-500/30 hidden lg:block scale-in-badge">
                <div className="text-xl font-black text-white mb-1">UPTO-20x</div>
      ...
      <section className="py-16 sm:py-32">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-24 space-y-4">
            ...
            <h2 className="text-2xl sm:text-5xl font-black text-solar-deep tracking-tight">Commercial Landmarks</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              { img: Commercial2 , title: 'Tech Park Solar Carport', loc: 'Rangareddy, India', size: '2.5 MW' },
              { img: home2  , title: 'Textile Factory Rooftop', loc: 'Hindupuram, India', size: '1.2 MW' },
              { img: commercial3 , title: 'Cold Storage Hybrid System', loc: 'Bimavaram, India', size: '800 kW' },
            ].map((proj, i) => (
              <div key={i} className="group cursor-pointer">
                <div className="rounded-[2rem] sm:rounded-[3rem] overflow-hidden aspect-[4/3] mb-4 sm:mb-8 shadow-2xl relative">
                  <img loading="lazy" src={proj.img} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt={proj.title} />
                  <div className="absolute inset-0 bg-gradient-to-t from-solar-deep/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-6 sm:p-10">
                    <div className="text-white space-y-1">
                      ...
                      <p className="font-bold text-base sm:text-lg">{proj.loc}</p>
                    </div>
                  </div>
                </div>
                <h3 className="text-xl sm:text-2xl font-black text-solar-deep group-hover:text-solar-primary transition-colors">{proj.title}</h3>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-32 bg-slate-50">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-20 space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-black text-solar-deep tracking-tight">What Our Clients Say</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            {[
              { name: 'Rajesh Krishnamurthy', role: 'COO, TechPark Solutions', quote: 'ROI exceeded our projections by 15%. The Wattex team delivered a world-class 2.5MW installation that transformed our energy costs completely.', image: review1, rating: 5 },  
              { name: 'Sunita Menon', role: 'Director, GreenTextiles Ltd', quote: 'Energy costs dropped 70% in year one. Their engineering precision and project management is unmatched in the industry.', image: review2, rating: 5 },
              { name: 'Amit Patel', role: 'CFO, ColdChain Corporation', quote: 'Best infrastructure investment we have made in a decade. The hybrid system handles our 24/7 cold storage needs flawlessly.', image: review3, rating: 5 },
            ].map((t, i) => (
              <div key={i} className="bg-white p-6 sm:p-10 lg:p-12 rounded-[2rem] sm:rounded-[3rem] border border-slate-100 shadow-xl group hover:shadow-2xl transition-all duration-500 relative">
                ...
                <div className="flex items-center gap-4 mb-6 sm:mb-8">
                  <img loading="lazy" src={t.image} alt={t.name} className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl object-cover border-2 border-white shadow-lg" referrerPolicy="no-referrer" />
                  <div>
                    <h4 className="font-black text-solar-deep text-sm sm:text-base">{t.name}</h4>
                ...
                <div className="flex gap-1 text-solar-primary mb-4 sm:mb-6">
                  {[...Array(t.rating)].map((_, j) => <i key={j} className="fas fa-star text-xs"></i>)}
                </div>
                <p className="text-slate-600 text-base font-medium italic leading-relaxed relative z-10">"{t.quote}"</p>
              </div>
            ))}
          </div>
        </div>
