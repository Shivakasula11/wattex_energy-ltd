...
const Contact = () => {
  ...
  return (
    <div className="animate-fade-in bg-white min-h-screen">
      ...
      {/* Hero */}
      <section className="relative h-[100vh] sm:h-[75vh] md:h-[100vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            loading="lazy"
            src={Contactus}
            className="w-full h-full object-cover object-[33%_center] sm:object-center"
            alt="Wattex Energy office — solar consultation and customer support"
          />

          <div className="absolute inset-0 bg-black/40 sm:bg-black/30"></div>
        </div>
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-4xl space-y-4 sm:space-y-8 animate-slide-up">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white font-heading leading-[1] tracking-tighter uppercase">
              {" "}
              Engineering <br />
              <span className="text-solar-primary">Connections</span>.
            </h1>
            <p className="text-white/60 text-xl md:text-2xl max-w-2xl font-medium leading-relaxed">
              Transitioning to renewable energy requires precision. Our
              technical advisors are ready to architect your sustainable
              infrastructure.
            </p>
          </div>
        </div>
            ...
            <div className="lg:col-span-5 space-y-16">
              <div className="space-y-6">
                ...
                <p className="text-slate-500 text-xl font-medium leading-relaxed">
                  Start your journey toward zero-carbon operations. Choose a
                  specialized department to expedite your inquiry.
                </p>
              </div>
              ...
              <div className="grid gap-4">
                {DEPARTMENTS.map((item, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between p-8 rounded-[2.5rem] bg-slate-50 border border-slate-100 hover:bg-white hover:shadow-4xl transition-all duration-500 group"
                  >
                    <div className="flex items-center gap-6">
                      <div
                        className={`w-12 h-12 flex items-center justify-center ${item.colorClass} text-xl bg-white rounded-xl shadow-sm`}
                      >
                      ...
                      <div>
                        ...
                        <p className="text-solar-deep font-bold text-lg">
                          {item.email}
                        </p>
                      </div>
                    </div>
              ...
              <div className="space-y-6 pt-10">
                <h3 className="text-2xl font-black text-solar-deep px-4">
                  Common Briefings
                </h3>
                  ...
                  {!submitted ? (
                      ...
                      <div className="mb-12 pb-8 border-b border-slate-100">
                        <div className="flex items-start justify-between mb-6">
                          <div className="flex-1">
                            ...
                            <h3 className="text-3xl lg:text-4xl font-black text-solar-deep mb-3 tracking-tight">
                              Project Initiation Form
                            </h3>
                            <p className="text-slate-500 text-base leading-relaxed">
                              Complete the form below to begin your renewable
                              energy transformation. Our technical team will
                      ...
                      <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="space-y-6">
                          <div className="flex items-center gap-3 mb-4">
                            <div className="w-8 h-8 bg-solar-deep rounded-lg flex items-center justify-center text-white text-sm font-bold">
                              1
                            </div>
                            <h4 className="text-sm font-black uppercase tracking-wider text-solar-deep">
                              Contact Information
                            </h4>
                          </div>
                          ...
                          <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2.5">
                              <label
                                htmlFor="clientName"
                                className="block text-xs font-bold uppercase tracking-wider text-slate-600 ml-1"
                              >
                                Full Name{" "}
                              ...
                              <div className="relative group">
                                <div
                                  className={`absolute inset-0 bg-gradient-to-r from-solar-sky to-solar-primary rounded-2xl opacity-0 group-focus-within:opacity-100 blur transition-opacity duration-300`}
                                ></div>
                                <input
                                  id="clientName"
                                  required
                                ...
                                />
                                <i
                                  className={`fas fa-user absolute right-5 top-1/2 -translate-y-1/2 text-slate-300 transition-colors ${focusedField === "clientName" ? "text-solar-sky" : ""}`}
                                ></i>
                              </div>
                            </div>
                            ...
                            <div className="space-y-2.5">
                              ...
                              <div className="relative group">
                                ...
                                />
                                <i
                                  className={`fas fa-envelope absolute right-5 top-1/2 -translate-y-1/2 text-slate-300 transition-colors ${focusedField === "email" ? "text-solar-sky" : ""}`}
                                ></i>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2.5">
                              ...
                              <div className="relative group">
                                ...
                                />
                                <i
                                  className={`fas fa-phone absolute right-5 top-1/2 -translate-y-1/2 text-slate-300 transition-colors ${focusedField === "phone" ? "text-solar-sky" : ""}`}
                                ></i>
                              </div>
                            </div>
                            ...
                            <div className="space-y-2.5">
                              ...
                              <div className="relative group">
                                ...
                                >
                                  ...
                                  <option value="Industrial Microgrid">
                                    Industrial Microgrid
                                  </option>
                                  <option value="Utility Scale Solar Farm">
                                    Utility Scale Solar Farm
                                  </option>
                                  <option value="EV Fleet Infrastructure">
                                    EV Fleet Infrastructure
                                  </option>
                                  <option value="Residential Solar">
                                    Residential Solar
                                  </option>
                                  <option value="Society/Community Solar">
                                    Society/Community Solar
                                  </option>
                                  <option value="On-Grid Solar System">
                                    On-Grid Solar System (Grid-Tied)
                                  </option>
                                  <option value="Off-Grid Solar System">
                                    Off-Grid Solar System (Standalone)
                                  </option>
                                </select>
                                <i
                                  className={`fas fa-chevron-down absolute right-5 top-1/2 -translate-y-1/2 text-slate-300 text-sm transition-colors pointer-events-none ${focusedField === "sector" ? "text-solar-sky" : ""}`}
                                ></i>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="space-y-6 pt-4">
                          ...
                          <div className="space-y-2.5">
                            ...
                            <p className="text-xs text-slate-400 ml-1 flex items-center gap-2">
                              ...
                              Include site location, available roof/land area,
                              current energy consumption, and project goals
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4 pt-4">
                          ...
                          <label
                            htmlFor="tfs"
                            className="flex items-start gap-4 p-5 bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl border-2 border-amber-100 cursor-pointer hover:border-amber-200 transition-all group"
                          >
                            <input
                              id="tfs"
                              type="checkbox"
                            ...
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-1">
                                <span className="text-sm font-bold text-amber-900">
                                  Request Priority Technical Feasibility Study
                                  (TFS)
                                </span>
                              ...
                              <p className="text-xs text-amber-700 leading-relaxed">
                                Get a comprehensive analysis including site
                                assessment, energy modeling, ROI projections,
                                and regulatory compliance review within 48
                                hours.
                              </p>
                            </div>
                          </label>
                          ...
                          <div className="flex gap-3">
                            ...
                            <div>
                              <p className="text-xs text-slate-600 leading-relaxed">
                                ...
                                All information submitted through this form is
                                encrypted and handled in accordance with our
                                data protection policies. We will never share
                    ...
                    <div className="text-center py-20 px-12 space-y-10 animate-zoom-in">
                      ...
                      <div className="space-y-4">
                        <h3 className="text-4xl font-black text-solar-deep tracking-tight">
                          Submission Successful!
                        </h3>
                        <p className="text-slate-500 font-medium text-lg max-w-md mx-auto leading-relaxed">
                          Your project brief has been received and assigned to
                          our{" "}
                        ...
                        <div className="space-y-3 text-left">
                          <div className="flex gap-3">
                            ...
                            <p className="text-sm text-slate-600">
                              Review by technical team within 24 hours
                            </p>
                          </div>
                          <div className="flex gap-3">
                            <div className="w-6 h-6 bg-solar-primary/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
          ...
          <div className="space-y-12">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              ...
              <div className="flex items-center gap-6 p-6 bg-slate-50 rounded-3xl border border-slate-100">
                ...
                <div>
                  <p className="text-solar-deep font-black">
                    {" "}
                    Mindspace, Madhapur
                  </p>
      ...
      <section className="py-24 border-t border-slate-50 bg-slate-50/30">
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap justify-center gap-12 lg:gap-24 grayscale opacity-30 hover:grayscale-0 hover:opacity-100 transition-all duration-700">
            {[
              "ISO 9001 Certified",
              "LEED Platinum Partner",
              "TÜV Rheinland Approved",
              "Engineering Council Member",
            ].map((badge, i) => (
              <div
                key={i}
                className="flex items-center gap-3 font-black text-solar-deep uppercase tracking-tighter text-xl"
              >
